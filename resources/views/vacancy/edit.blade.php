            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Editar vacante
                    </div>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea rows="3" id="editor1">{!! $vacancy->description !!}</textarea>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <p class="text-center">
                                <button class="btn btn-success" @click="update()">Editar</button>
                            </p>
                        </div>
                    </div>
        ...
        const app = new Vue({
            ...
            methods:{
                ...
                update(){
                    ...
                    this.loading = true
                    axios.post("{{ url('/vacancies/update') }}", {title:this.title, description: this.description, "country": this.country, "id": this.id}).then(res => {
                    this.loading = false
