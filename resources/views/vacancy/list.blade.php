            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--end::Dropdown-->
                        <!--begin::Button-->
                        <a href="{{ url('/vacancies/create') }}" class="btn btn-primary font-weight-bolder">
                        <span class="svg-icon svg-icon-md">
                        ...
                        <table class="table">
                            <thead>
                                <tr >
                                    <th class="datatable-cell datatable-cell-sort">
                                        <span style="width: 250px;">Posición</span>
                                    </th>

                                    <th class="datatable-cell datatable-cell-sort" style="width: 250px;">
                                        <span style="width: 130px;">País</span>
                                    </th>
                                    <th class="datatable-cell datatable-cell-sort">
                            ...
                            <tbody>
                                <tr v-for="vacancy in vacancies">
                                    ...
                                    <td>
                                        @{{ dateFormatter(vacancy.created_at) }}
                                    </td>
                                    <td>
                                        <a class="btn btn-info" :href="'{{ url('/') }}'+'/vacancies/edit/'+vacancy.id"><i class="far fa-edit"></i></a>
                                        <button class="btn btn-secondary" @click="erase(vacancy.id)"><i class="far fa-trash-alt"></i></button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
        ...
        const app = new Vue({
            ...
            methods:{
                ...
                fetch(page = 1){
                    ...
                    axios.get("{{ url('/vacancies/fetch/') }}"+"/"+page)
                    .then(res => {

                        this.vacancies = res.data.vacancies
                        this.pages = Math.ceil(res.data.vacanciesCount / res.data.dataAmount)
                ...
                erase(id){
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            this.loading = true
                            axios.post("{{ url('/vacancies/delete/') }}", {id: id}).then(res => {
                                this.loading = false
